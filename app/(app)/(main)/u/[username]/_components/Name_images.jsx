...
export default function Name_images({profile_demo_gen,changer})
{
  ...
  const[edit_flag,ch_edit_flag]=useState(1)
    ...
    <button className="btn" style={{float:"right",margin:"3px",color:"blue"}} onClick={()=>ch_edit_flag(2)}>
      <a>
      <FontAwesomeIcon icon={faUserPen} />
      </a>
    </button>
    <img className={styles.profile_photo} src={profile_demo_gen.background_img} />
   
    <div style={{ marginTop: "50px" }} className={styles.inf_con}>
      <div className="container-fluid row">
        <div className="col-md-8 col-12">
            <div className="d-flex justify-content-between">
       {profile_demo_gen.flag==1 && <div> <a href="#">See posts</a> </div>}
        {profile_demo_gen.flag==2 && <div><a href="#">Saved posts</a> </div>}
    ...
    {edit_flag==2 && <AddLink />}
    {edit_flag==2 && <Edit_profile profile_demo_gen={profile_demo_gen} change_edit_flag={ch_edit_flag} changer={changer}  />}
  </div>
    )
}
