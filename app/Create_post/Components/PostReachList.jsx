...
export default function PostReachList({name,crt_post,changeCon})
{
   // console.log(crt_post.post_cat,name,crt_post.post_cat==name);
    ...
    return(
        ...
        {
            //e.preventDefault()
            changeCon({...crt_post,post_cat:name})

        }
        }>
        <div className="d-flex ps-3">
            <input className={`{styles.sub_photo} align-self-center`} name="post_catagory" id={name} type="radio" checked={crt_post.post_cat==name}  />
